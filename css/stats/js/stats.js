  ...
  function($http) {
    ...
    function sortFontSizes(stats) {
      var sortBy = function(a, b) {
        var c = fontSizeToPx(a.value);
        var d = fontSizeToPx(b.value);
        if (c > d) {
          return -1;
        } else {
          return 1;
    ...
    service.init = function() {
      ...
      var promise = $http.get('/css/skeletor.json')
        .then(function(res){
          model.stats = res.data;
